  ...
  _createClass(TwitterLogin, [{
    ...
    value: function authenticate() {
      ...
      return window.fetch(this.props.requestTokenUrl, {
        ...
        var authorizationUrl = data.authorizationURL; // Assuming this is the key in the JSON response
        if (!authorizationUrl) {
    ...
    value: function polling(popup) {
      ...
      var polling = setInterval(function () {
        ...
        try {
          if (!popup.location.hostname.includes("localhost") && !popup.location.hostname == "") {
    ...
    value: function getOauthToken() {
      ...
      fetch(this.props.loginUrl, options).then(function (response) {
