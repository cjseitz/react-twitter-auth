  ...
  _createClass(TwitterLogin, [{
    ...
    value: function authenticate() {
      ...
      return fetch(this.props.requestTokenUrl, {
        ...
        var authorizationUrl = data.authUrl;
        if (!authorizationUrl) {
        ...
        try {
          if (!popup.location.hostname.includes("api.twitter.com") && !popup.location.hostname == "") {
            if (popup.location.search) {
              ...
              closeDialog();
              return _this3.getOauthToken(params.toString());
            } else {
              closeDialog();
    ...
    value: function getOauthToken(oauthVerifier, oauthToken) {
      ...
      fetch(this.props.loginUrl + "?oauth_verifier=" + oauthVerifier + "&oauth_token=" + oauthToken, options).then(function (response) {
